namespace Configuration.SimpleConfiguration
{
    ...
    public class ConfigWrapperImpl<T> : IConfigWrapper<T> where T : new()
    {
        public T Value { get; private set; }


        public ConfigWrapperImpl(IConfigWrapperBuilder configWrapperBuilder)
        {
            this.Value = configWrapperBuilder.PopulateConfigObject<T>();
        }
    }
